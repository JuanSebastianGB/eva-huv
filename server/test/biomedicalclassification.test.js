...
const ENDPOINT = '/biomedicalclassifications';

describe('API', () => {
  beforeEach(async () => {
    const models = [BiomedicalClassification];
  ...
  describe(`Get ${ENDPOINT} Get By Id`, async () => {
    ...
    it('Error when try to get a biomedicalClassification when id is not a number', async () => {
  ...
  describe(`PUT ${ENDPOINT}/id`, () => {
    ...
    it('Error when try to update a biomedicalClassification when id is not a number', async () => {
