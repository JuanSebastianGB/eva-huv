...
const ENDPOINT = '/filetypes';

describe('API', () => {
  beforeEach(async () => {
    const models = [FileType];
  ...
  describe(`Get ${ENDPOINT} Get By Id`, async () => {
    ...
    it('Error when try to get a fileType when id is not a number', async () => {
  ...
  describe(`PUT ${ENDPOINT}/id`, () => {
    ...
    it('Error when try to update a fileType when id is not a number', async () => {
