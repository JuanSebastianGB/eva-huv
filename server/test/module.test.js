...
describe('API', () => {
  beforeEach(async () => {
    const models = [UserModule, Module];
  ...
  describe(`Get ${ENDPOINT} Get By Id`, async () => {
    ...
    it('Error when try to get a module when id is not a number', async () => {
  ...
  describe(`PUT ${ENDPOINT}/id`, () => {
    ...
    it('Error when try to update a module when id is not a number', async () => {
