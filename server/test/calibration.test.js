...
describe('API', () => {
  ...
  describe(`Get ${ENDPOINT} Get By Id`, async () => {
    ...
    it('Error when try to get a calibration when id is not a number', async () => {
  ...
  describe(`PUT ${ENDPOINT}/id`, () => {
    ...
    it('Error when try to update a calibration when id is not a number', async () => {
